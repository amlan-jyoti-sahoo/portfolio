                    ...
                    >
                        ...
                        <div className="flex justify-between items-center p-4 border-b border-white/10 bg-bg-dark z-10">
                            ...
                            <div className="flex items-center gap-4">
                                <a 
                                    href="https://drive.google.com/file/d/1_luZt1s5ovRHTOjTnNiYPsPK6THgV6Cc/view?usp=sharing" 
                                    target="_blank" 
                        ...
                        <div className="flex-grow bg-gray-900 relative">
                             ...
                             <iframe 
                                          src="https://drive.google.com/file/d/1_luZt1s5ovRHTOjTnNiYPsPK6THgV6Cc/preview" 
